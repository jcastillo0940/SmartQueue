...
Route::middleware(['auth', 'verified', 'tenant'])->group(function (): void {
    ...
    Route::get('/sucursales/{branch}/kiosco', [TicketController::class, 'kiosk'])->name('kiosk.index');
    Route::post('/sucursales/{branch}/kiosco/tickets', [TicketController::class, 'store'])->name('tickets.store');

    // NUEVA RUTA: MONITOR PÚBLICO
    Route::get('/sucursales/{branch}/monitor', [TicketController::class, 'publicDisplay'])->name('public.monitor');
